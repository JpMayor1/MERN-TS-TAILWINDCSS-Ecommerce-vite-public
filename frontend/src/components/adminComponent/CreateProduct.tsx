...
const CreateProduct = ({ toggleCreateModal }: toggleType) => {
            ...
            await axios
                ...
                .then((res) => {
                    ...
                    const newProduct = {
                        ...
                        countInStock: parseInt(Number(countInStock).toFixed(2)),
                        image: res.data.imageUrl,
                        publicId: res.data.publicId,
                    };

                    axios
                        .post(`${API}/api/products/create`, newProduct, {
                            headers: {
    ...
    return (
        <div className="mt-4 p-4 border border-gray-300 rounded bg-white shadow-md max-w-[400px] w-full">
            <h2 className="text-lg font-semibold mb-2">Create Product</h2>
            <form onSubmit={handleSubmit}>
                <div className="flex items-start justify-center gap-3 max-[600px]:flex-col max-[600px]:items-center">
                    <div>
                        <div className="mb-3">
                ...
                <button
                    type="submit"
                    className="bg-blue-600 hover:bg-blue-500 text-white px-4 py-2 rounded shadow focus:outline-none focus:ring focus:ring-blue-300 w-full"
                >
                    {isLoading ? (
